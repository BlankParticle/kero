...
enum TerminalBackend: String, CaseIterable, Identifiable, Sendable {
    ...
    var summary: String {
        ...
        case .alacritty:
            "Alacritty's emulator core, drawn by Kero. Terminal image protocols and Ghostty-specific OSC 9 progress and notification sequences remain Ghostty-only; open a new terminal for a change here to take effect."
        }
    }
